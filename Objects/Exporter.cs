...
namespace Cyclone.Objects {
    public class Exporter {
        ...
        public static List<string> InventoryReport(List<Bike> inventory) {
            List<string> report = new List<string>();

            string[] titles = { " No. ", " Make ", " Model ",
                " Type ", " Year ", " Purchased ", " Security Code " };
            string[] totalsTitles = { " Bikes " };

            string[][][] purchaseTableContent = new string[inventory.Count][][];
            string[][][] totalsTableContent = new string[1][][];

            int bikeIndex = 0;

            foreach (Bike bike in inventory) {
                string[][] row = new string[titles.Length][];
                ...
                row[1] = new string[] {
                    string.Format(" {0} ", bike.Make)
                };

                row[2] = new string[] {
                    string.Format(" {0} ", bike.Model)
                };
                ...
                row[6] = new string[] {
                    string.Format(" {0} ", bike.SecurityCode)
                };
            ...
            totalsTableContent = new string[][][] { 
                new string[][] {
                    new string[] {
                        string.Format(" {0} ", inventory.Count.ToString().Trim())
                    }
                }
            };
